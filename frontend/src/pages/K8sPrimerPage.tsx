      ...
      <article className="spark-primer-notebook">
        ...
        <section id="next" className="spark-primer-section spark-primer-next">
          ...
          <p className="spark-primer-copy">
            You do not need every Kubernetes resource first. You need the story above — one host
            hits a wall; the cluster keeps desired state true — then practice. Official docs if you
            want more depth after a few labs.
          </p>
