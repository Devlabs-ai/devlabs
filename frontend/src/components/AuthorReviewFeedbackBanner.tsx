...
import { tagLabel } from '../constants/reviewFeedbackTags';
import type { ReviewFeedbackEntry } from '../types/domain';

interface AuthorReviewFeedbackBannerProps {
  feedback: ReviewFeedbackEntry | null | undefined;
}

function formatWhen(ts: string | number | undefined): string {
  if (!ts) return '';
  try {
...
export default function AuthorReviewFeedbackBanner({ feedback }: AuthorReviewFeedbackBannerProps): JSX.Element | null {
