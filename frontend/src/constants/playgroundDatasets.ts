...
/** Wide fact schema for 100m* drops (15 columns). */
const TXN_SCHEMA_WIDE: PlaygroundColumn[] = [
  { column: 'txn_id', type: 'STRING' },
  { column: 'txn_ts', type: 'TIMESTAMP' },
...
const CARD_RAILS_TABLES: PlaygroundTable[] = [
  {
    ...
    label: 'txns / 10k',
    kind: 'fact',
    path: `${PAYMENT}/txns/10k/`,
    blurb: 'Small settlement-style drop for quick smoke / join practice.',
    schema: TXN_SCHEMA,
    rowCount: 10_000,
    sizeBytes: 347_991,
    fileCount: 1,
    ...
    sampleRows: [
      {
        ...
        txn_ts: '2024-04-11T06:34:51.066099',
        card_token: 'tok_00001229',
        amount: '12.37',
        currency_code: 'USD',
        country_code: 'US',
        mcc: '6010',
        merchant_id: 'MID0021736',
        acquirer_bin: '400004',
        response_code: '00',
        entry_mode: 'ecom',
        channel: 'atm',
      },
      {
        ...
        txn_ts: '2024-04-17T13:37:32.527070',
        card_token: 'tok_00002892',
        amount: '10.35',
        currency_code: 'USD',
        country_code: 'US',
        mcc: '7011',
        merchant_id: 'MID0035998',
        acquirer_bin: '400014',
        response_code: '00',
      ...
      {
        txn_id: 'TXN000000000003',
        txn_ts: '2024-05-14T07:51:18.477140',
        card_token: 'tok_00005825',
        amount: '15.77',
        currency_code: 'GBP',
        country_code: 'GB',
        mcc: '5912',
        merchant_id: 'MID0038677',
        acquirer_bin: '400009',
        response_code: '00',
  ...
  },
  {
    ...
    label: 'txns / 100k',
    kind: 'fact',
    path: `${PAYMENT}/txns/100k/`,
    blurb: 'Settlement-style payment transactions for mid-size join practice.',
    schema: TXN_SCHEMA,
    rowCount: 100_000,
    sizeBytes: 3_121_845,
    fileCount: 1,
    ...
    sampleRows: [
      {
        txn_id: 'TXN000000000001',
        txn_ts: '2024-05-20T03:06:23.843813',
        card_token: 'tok_00067972',
        amount: '5.15',
        currency_code: 'GBP',
        country_code: 'GB',
        mcc: '5732',
        merchant_id: 'MID0016953',
        acquirer_bin: '400012',
        response_code: '00',
        entry_mode: 'moto',
        channel: 'atm',
      ...
      {
        txn_id: 'TXN000000000002',
        txn_ts: '2024-05-22T01:22:59.753438',
        card_token: 'tok_00063218',
        amount: '4.16',
        currency_code: 'USD',
        country_code: 'US',
        mcc: '7011',
        merchant_id: 'MID0035941',
        acquirer_bin: '400004',
        response_code: '00',
        entry_mode: 'contactless',
        channel: 'ecom',
      ...
      {
        txn_id: 'TXN000000000003',
        txn_ts: '2024-03-03T04:14:28.173093',
        card_token: 'tok_00050058',
        amount: '3.17',
        currency_code: 'TRY',
        country_code: 'TR',
        mcc: '5912',
        merchant_id: 'MID0042773',
        acquirer_bin: '400014',
        response_code: '00',
        entry_mode: 'contactless',
        channel: 'ecom',
  ...
  },
  {
    ...
    label: 'txns / 1m',
    kind: 'fact',
    path: `${PAYMENT}/txns/1m/`,
    blurb: '~1M payment transactions for broader aggregations.',
    schema: TXN_SCHEMA,
    rowCount: 1_000_000,
    sizeBytes: 28_212_265,
    fileCount: 1,
    format: 'Parquet',
    compression: 'Snappy',
    seed: SEED,
    ...
    sampleRows: [
      {
        txn_id: 'TXN000000000001',
        txn_ts: '2024-06-26T01:56:34.315299',
        card_token: 'tok_00059596',
        amount: '2.18',
        currency_code: 'NGN',
        country_code: 'NG',
        mcc: '4829',
        merchant_id: 'MID0002201',
        acquirer_bin: '400002',
        response_code: '00',
        entry_mode: 'contactless',
        channel: 'ecom',
      ...
      {
        txn_id: 'TXN000000000002',
        txn_ts: '2024-03-26T08:15:01.936835',
        card_token: 'tok_00023073',
        amount: '11.34',
        currency_code: 'USD',
        country_code: 'US',
        mcc: '7011',
        merchant_id: 'MID0039949',
        acquirer_bin: '400005',
        response_code: '00',
        entry_mode: 'manual',
        channel: 'ecom',
      ...
      {
        txn_id: 'TXN000000000003',
        txn_ts: '2024-04-27T18:03:45.909051',
        card_token: 'tok_00055808',
        amount: '45.23',
        currency_code: 'AUD',
        country_code: 'AU',
        mcc: '4121',
        merchant_id: 'MID0010312',
        acquirer_bin: '400003',
        response_code: '00',
        entry_mode: 'chip',
        channel: 'pos',
...
export const PLAYGROUND_CLUSTERS: PlaygroundCluster[] = [
  {
    ...
    blurb:
      'Card-network authorization and settlement facts at 10k–1M, plus 50m/100m-skew-key75 (wide 15-col) for single-hot-key join skew, with opcode dims.',
...
export const PLAYGROUND_PATH_CONSTANTS = {
  TXNS_10K: `${PAYMENT}/txns/10k/`,
  TXNS_100K: `${PAYMENT}/txns/100k/`,
  TXNS_1M: `${PAYMENT}/txns/1m/`,
